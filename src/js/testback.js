import { datefilm, dateactivites, listeinvites, oneID, oneIDActivites, oneIDInvites, allActiviteByInvites, allActiviteByName, addNewFilm, addNewInvite, addNewActivite, updateFilmById, updateInviteById, updateActiviteById } from './backend.mjs';
